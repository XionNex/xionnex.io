...
$sql="UPDATE tblcourse set CourseName=:cname,Code=:code where ID=:eid";
...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
  ...
  echo "<script>window.location.href = 'manage-programme.php'</script>";
}
...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Manage Course</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Manage Course </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Manage Course</h4>
