            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-programme.php">Add Programme</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-programme.php">Manage Programme</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="add-result-student.php">Add Result</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-result.php">Manage Result</a></li>
                  <span class="menu-title">Timetable</span>
                  <li class="nav-item"> <a class="nav-link" href="add-timetable.php">Add Timetable</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-timetable.php">Manage Timetable</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="manage-semester.php">
                <span class="menu-title">Recieve Form</span>
